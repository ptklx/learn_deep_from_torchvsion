...
from utils_my.data_utils import get_dataset_dataloader
...
def train_one_epoch(model, criterion, optimizer, data_loader, device, epoch, args, model_ema=None, scaler=None):
    ...
    for i, (image, target) in enumerate(metric_logger.log_every(data_loader, args.print_freq, header)):
        ...
        acc1, acc5 = utils.accuracy(output, target, topk=(1, g_classes-1))
...
def load_data(traindir, valdir, args):
    ...
    dataset, dataset_test = get_dataset_dataloader(traindir)
...
def main(args):
    ...
    dataset, dataset_test, train_sampler, test_sampler = load_data(args.data_path, args.data_path, args)
